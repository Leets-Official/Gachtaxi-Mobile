...
class _$UserDataImpl implements _UserData {
  ...
  @override
  String toString() {
    return 'UserData(userId: $userId, studentNumber: $studentNumber, nickName: $nickName, realName: $realName, profilePicture: $profilePicture, email: $email, role: $role, gender: $gender, accountNumber: $accountNumber)';
  }
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, userId, studentNumber, nickName,
      realName, profilePicture, email, role, gender, accountNumber);
...
abstract class _UserData implements UserData {
  const factory _UserData(
      ...
      final String? accountNumber}) = _$UserDataImpl;
